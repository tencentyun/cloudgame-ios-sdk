...
@implementation CAIDemoLoadingView
...
- (void)setProcessValue:(int)processValue {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        self->_processLab.text = [NSString stringWithFormat:@"正在全力加载···%d%%", processValue];
...
- (void)initSubviews {
    ...
    [iconImageView setImage:[UIImage imageNamed:@"CAI_cloud"]];
    ...
    _processLab.textColor = [CAIDemoUtils CAI_colorValue:@"81868C"];
    ...
    _processView.layer.backgroundColor = [CAIDemoUtils CAI_colorValue:@"2684FF"].CGColor;
